...
const QuizCompletedModal = ({ onClose }) => {
  return (
    <div className="sm:min-w-[200px] sm:max-w-[930px] min-w-[150px] max-w-[300px]  flex flex-col items-center min-h-auto bg-gradient-to-b  bg-[#b834c4] rounded-[10px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] p-4 m-4 sm:p-5">
