...
const DocumentHolder = ({ title, description, url, type }) => {
  return (
      ...
      <div className="p-3">
        <div className="flex justify-between pb-3">
          ...
          <a
            href={url}
            download
            className="w-auto h-[24.34px] bg-[#f1aa2e] rounded-[5px] items-center px-1 mt-3 flex justify-center"
          >
            I-download
            <img
        ...
        <div className="flex flex-col gap-3 mt-1">
          ...
          <p className="text-white text-xs font-normal">#{type}</p>
        </div>
      </div>
    </div>
  );
