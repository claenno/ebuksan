import React, { useState, useEffect } from "react";
                    ...
                    const EditVideo = ({ video, onClose }) => {
                        ...
                        const [preview, setPreview] = useState(video.video_thumbnail);
                        const [fileType, setFileType] = useState(null);
                        const [lessonTitle, setLessonTitle] = useState(video.video_name);
                        const [description, setDescription] = useState(video.video_description);
                        const [thumbnailurl, setThumbnailurl] = useState(video.video_thumbnail);
                        ...
                        const handleUpdate = async () => {
                            ...
                            try {
                                ...
                                const { error } = await supabase.from("videos").update({
                                    ...
                                    video_url: publicURL,
                                    video_thumbnail: thumbnailurl || publicURL,
                                }).eq('id', video.id);
                        ...
                        return (
                            <div className="w-[670px] h-auto bg-[#fe6462] rounded-[5px] p-6">
                                ...
                                <p className="font-bold text-black text-lg mb-6">Edit Lesson</p>
