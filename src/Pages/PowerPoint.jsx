    ...
    return (
        <>
            <div
                ...
                <div
                    className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-6 gap-5 pt-5">
                    {loading ? (
                        <p className="text-center text-white">Loading PowerPoints...</p>
                    ) : (
                        powerPoints.map((ppt) => (
                            <PowerPointHolder
                                key={ppt.id}
